...
func favoritesUrl(forAPIKey key:String,id:String) -> String{
let url = "https://api.flickr.com/services/rest/?method=flickr.photos.getFavorites&api_key=\(apiKey)&photo_id=\(id)&per_page=40&format=json&nojsoncallback=1"
    return url
}
